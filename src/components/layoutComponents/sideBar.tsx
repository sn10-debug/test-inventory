...
export default function Sidebar({ show, setter }: { show: boolean, setter: React.Dispatch<React.SetStateAction<boolean>> }) {
    const navigation=[{id:1,name:'Listings',route:'/listings'},{id:2,name:'Orders',route:'/admin/orders'},{id:3,name:'Statistics',route:'/stats'},{id:4,name:'Marketing',route:'/marketing'},{id:5,name:'Messages',route:'/messaging'}]
